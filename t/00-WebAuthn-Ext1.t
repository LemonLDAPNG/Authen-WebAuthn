...
is( $reg->{attestation_result}->{type}, "Self",
    "Attestation reported as Self" );
is( $reg->{attestation_result}->{aaguid}, undef,
    "Untrusted AAGUID is not reported" );

# packed attestation, unknown CA, untrusted registration is allowed, but "Self" is not allowed
eval {
    $reg = $webauthn->validate_registration(
        challenge_b64 =>
"8LBCiOY3q1cBZHFAWtS4AZZChzGphy67lK7I70zKi4yC7pgrQ2Pch7nAjLk1wq9greshIAsW2AjibhXjjI0TmQ",
